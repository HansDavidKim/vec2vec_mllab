...
### Default device for PyTorch tensors : CUDA would accelerate the training
device = torch.device("cuda" if torch.cuda.is_available() else "cpu")

''' 
This is a baseline translator that does not perform any translation.
It simply returns the input embeddings as output embeddings without any modifications.

This strongly assumes that the input and output embeddings are of the same dimension.
So it is not suitable for cases where the input and output embeddings have different dimensions.
''' 
