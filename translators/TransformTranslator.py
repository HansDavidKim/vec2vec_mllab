...
'''
This is a translator that actually performs non-linear transformation of embeddings.
It uses a MLP with residual connections as a block for the architecture components.
'''
